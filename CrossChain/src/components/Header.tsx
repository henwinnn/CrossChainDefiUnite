  ...
  return (
    <header className="w-full px-4 py-6 flex items-center justify-between relative z-50">
      ...
      <nav className="hidden md:flex items-center space-x-8">
        <a href="#" className="text-[#f8f3ce] hover:text-[#dddad0] transition-colors">Bridge</a>
        <a href="#" className="text-[#dddad0]/70 hover:text-[#f8f3ce] transition-colors">USDC</a>
        <a href="#" className="text-[#dddad0]/70 hover:text-[#f8f3ce] transition-colors">Explorer</a>
        <a href="#" className="text-[#dddad0]/70 hover:text-[#f8f3ce] transition-colors">Legacy Tools</a>
      </nav>
      ...
      >
        {isMobileMenuOpen ? <X size={24} className="text-[#f8f3ce]" /> : <Menu size={24} className="text-[#f8f3ce]" />}
      </button>
